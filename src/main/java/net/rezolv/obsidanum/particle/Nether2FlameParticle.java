...
@OnlyIn(Dist.CLIENT)
public class Nether2FlameParticle extends TextureSheetParticle {
    Nether2FlameParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
